    ...
    <div className="flex flex-col md:flex-row justify-around items-center h-screen gap-x-4 bg-slate-200 rounded-2xl shadow-lg">
      ...
      <div className="bg-slate-400 rounded-lg p-6 shadow-md">
        <form className="flex flex-col gap-3">
          ...
          <input type="email" name='email' onChange={handleChange} placeholder="Email" value={formData.email} className="px-3 py-2 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
          <input type="password" name='password' onChange={handleChange} value={formData.password} placeholder="Password" className="px-3 py-2 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        
          <button onClick={handleSubmit} className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-300 shadow-md">Login</button>
        </form>
      </div>
    </div></>
  )
